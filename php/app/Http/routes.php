...
Route::group(['middleware' => 'guest'], function () {
    Route::group(['namespace' => 'Admin'], function () {
        ...
        Route::post('user/send_sms', ['as' => 'user.send_sms', 'uses' => 'Bell_userController@Send_sms']);//发送短信
...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['namespace' => 'Admin'], function () {
        ...
        Route::any('alipay/AliPayClient', ['as' => 'alipay.AliPayClient', 'uses' => 'OrderController@AliPayClient']);//ios支付请求
        Route::any('alipay/alipayNotify', ['as' => 'alipay.alipayNotify', 'uses' => 'PaymentController@alipayNotify']);//手机支付异步通知
        Route::any('alipay/webpayment', ['as' => 'alipay.webpayment', 'uses' => 'PaymentController@webpayment']);//网页测试支付
        // 查询物流
        ...
        Route::post('user/daily_record', ['as' => 'user.daily_record', 'uses' => 'Apicontroller@daily_record']);//发表日记
        ...
        Route::get('gclass/choose', ['as' => 'gclass.choose', 'uses' => 'ClassificationController@choose']);//商品列表
		...
		Route::get('/artice/Looks', ['as' => 'artice.Looks', 'uses' => 'ArticeControll@Looks']);//课堂详细信息
        Route::get('/artice/sift', ['as' => 'artice.sift', 'uses' => 'ArticeControll@sift']);//主题详细信息
        ...
        Route::post('/artice/Brand_Dele', ['as' => 'artice.Brand_Dele', 'uses' => 'ArticeControll@Brand_Dele']);//品牌删除
		
		
		Route::post('/artice/attribute', ['as' => 'artice.attribute', 'uses' => 'ArticeControll@attribute']);//品牌删除
		...
		Route::get('/gclass/goods_hot', ['as' => 'gclass.goods_hot', 'uses' => 'ClassificationController@goods_hot']);//热卖推荐
        //地址管理
        ...
        Route::post('/gclass/ressupdate', ['as' => 'gclass.ressupdate', 'uses' => 'ClassificationController@ressupdate']);//地址管理更新
		Route::get('/gclass/ressdefault', ['as' => 'gclass.ressdefault', 'uses' => 'ClassificationController@ressdefault']);//默认地址管理
        //积分商城
        ...
        Route::get('goods/updateshop', ['as' => 'goods.updateshop', 'uses' => 'GoodsController@updateshop']);//添加购物车
		//订单评论
	     Route::get('gclass/add_comment', ['as' => 'gclass.add_comment', 'uses' => 'ClassificationController@add_comment']);//订单评论
        Route::get('gclass/commentlist', ['as' => 'gclass.commentlist', 'uses' => 'ClassificationController@commentlist']);//订单评论列表
        //订单
		...
		Route::get('artice/B_dingdan_read', ['as' => 'artice.B_dingdan_read', 'uses' => 'SortController@B_dingdan_read']);//订单详情
		Route::get('artice/UpdateOrderType', ['as' => 'order.UpdateOrderType', 'uses' => 'SortController@UpdateOrderType']);//订单详情
		Route::get('artice/B_backlist_read', ['as' => 'artice.B_backlist_read', 'uses' => 'SortController@B_backlist_read']);
		/**
		 *直播 管理
		 */
        Route::get('anchor/index', ['as' => 'anchor.index', 'uses' => 'AnchorController@index']);
		Route::get('anchor/addanchor', ['as' => 'anchor.addanchor', 'uses' => 'AnchorController@addanchor']);
		Route::get('anchor/up_anchor', ['as' => 'anchor.up_anchor', 'uses' => 'AnchorController@up_anchor']);
		Route::get('anchor/livelist', ['as' => 'anchor.livelist', 'uses' => 'AnchorController@livelist']);
		Route::get('anchor/followers', ['as' => 'anchor.followers', 'uses' => 'AnchorController@followers']);
		
		Route::get('anchor/start', ['as' => 'anchor.start', 'uses' => 'AnchorController@start']);//开播
		Route::get('anchor/into', ['as' => 'anchor.into', 'uses' => 'AnchorController@into']);//成为直播
		Route::get('anchor/delinto', ['as' => 'anchor.delinto', 'uses' => 'AnchorController@delinto']);//成为会员
        //文件上传, 图片处理
