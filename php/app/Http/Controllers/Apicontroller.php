...
//                $mine[$i][0]["share_pic"] = $mine[$i][0]["share_pic"];
   ...
   /**
	 ...
	 public function HomeData()
    {
		...
		{
			if($topic_data[$i]["topic_photo"])
			{
			$topic_data[$i]["topic_photo"]=$topic_data[$i]["topic_photo"];
			}
			else
			{
				$topic_data[$i]["topic_photo"]="";
			}
			if($topic_data[$i]["topic_name"])
			{
			$topic_data[$i]["topic_name"]=$topic_data[$i]["topic_name"];
			}
			else
			{
				$topic_data[$i]["topic_name"]="";
			}
		}
		if($topic_data)
		{
