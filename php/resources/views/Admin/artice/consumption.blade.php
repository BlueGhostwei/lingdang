...
<div class="Iartice">
    <div class="IAhead"><strong style="padding-right: 10px;">账户查询</strong><a href="{{ route('artice.consumption') }}">消费记录</a>|<a href="{{ route('artice.chongzhi') }}">充值记录</a>|<a href="{{ route('artice.member_list') }}">会员列表</a>|<a href="{{ route('artice.member') }}">添加会员</a>|</div>
