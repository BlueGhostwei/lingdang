...
<div class="Iartice">
    <div class="IAhead"><strong style="padding-right: 10px;">商品分类管理</strong><a href="{{ route('artice.goods') }}">分类列表</a>|<a href="{{ route('artice.Add_subtopic',0) }}">添加分类</a>|<a href="{{ route('goods.goods_list') }}">商品列表</a>|<a href="{{ route('brand.brand_list') }}">品牌列表</a>|</div>
