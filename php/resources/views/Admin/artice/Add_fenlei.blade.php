...
<div class="Iartice">
    ...
    <div class="IAMAIN">
        <form method="post" action="@if(isset($Rst_Data)){{route('support.update')}}@else{{route('artice.save_fenlei')}}@endif">
            {{csrf_field()}}
                ...
                <tr>
                    ...
                    <td>
                          @if(isset($Rst_Data))
                            ...
                            @endif
                        <input  type="text" name="sort_name"  value="{{isset($Rst_Data)?$Rst_Data->name:''}}" class="Iar_input"></td>
                </tr> 
                <tr>
                    <td align="right">排列顺序：</td>
                    <td><input type="text" name="sort_num" value="{{ isset($Rst_Data)? $Rst_Data->num:''}}" class="Iar_inpun" /></td>
                </tr>  
