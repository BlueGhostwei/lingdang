...
<div class="Iartice">
    <div class="IAhead"><strong style="padding-right: 10px;">品牌管理</strong><a href="{{ route('brand.brand_list') }}">品牌列表</a>|<a href="{{ route('artice.Add_brand') }}">添加品牌</a>|<a href="{{ route('goods.goods_list') }}">商品列表</a>|<a href="{{ route('goods.Add_goods') }}">添加商品</a>|</div>
